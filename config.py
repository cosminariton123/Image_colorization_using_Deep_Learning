...
REDUCE_LR_MIN_LR = 0.000000000001
#TODO change back to 24
TRAINING_BATCH_SIZE = 4#24 #Should be multiple of 8(even better 128 for TPUs) for better efficiency
...
PROFILE_BATCH = (1, 100)
TRAINING_IMAGE_DIFFERENT_SAMPLES_TO_LOG = 5
TRAINING_IMAGE_SAME_SAMPLE_TO_LOG = 5
